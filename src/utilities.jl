...
- `skip_lines::Int64 = 1`: the number of dates at the top of `iss_infn_dataframe` whose recosntructed incidences would not be part of the average.
"""
function unroll_iss_infn(iss_infn_dataframe::DataFrame, n₋::Int64, n₊::Int64, horizontal_check_cases::Union{Nothing,Vector{Int64}}; initial_conditions_dataframe::U = nothing, assert_positive_integer::Bool = true, skip_lines::Int64 = 1 ) where { U <: Union{ DataFrame,Nothing} } #Tuple{Vararg{Union{Int64,Float64}}}
